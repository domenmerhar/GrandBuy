...
/**
 * Pridobi elemente košarice uporabnika s podporo za filtriranje in paginacijo.
 * @param {object} arguments - Argumenti za pridobivanje elementov košarice.
...
export const getCartItems = async ({
  ...
  const res = await fetch(toApiPath(`cart?${queryParamsStr}`), {
    method: "GET",
    headers: {
